...
export const useStore = create((set) => ({
    ...
    getFoodCount: async () => {
        try {
            const response = await fetch("https://agomoni-2k25-2.onrender.com/api", {
                method: "GET",
                headers: {
    ...
    findStudentID: async (stdData) => {
        try {
            ...
            const response = await fetch("https://agomoni-2k25-2.onrender.com/api/students/findstudents", {
                method: "POST",
                headers: {
                    "content-type": "application/json"
                },
    ...
    createUser: async (users) => {
        try {
            ...
            const response = await fetch("https://agomoni-2k25-2.onrender.com/api/students", {
                method: "POST",
                headers: {
                    "content-type": "application/json"
                },
    ...
    validateAdmin: async (adminData)=>{
        try {
            const response = await fetch("https://agomoni-2k25-2.onrender.com/api/admin/validate",
                {
                    method: "POST",
                    headers:{
                        "content-type":"application/json"
    ...
    adminLogin: async()=>{
        try{
            const response = await fetch("https://agomoni-2k25-2.onrender.com/api/admin/adminLogin", {
                method: "POST",
                headers: {
                    "content-type": "application/json"
                },
    ...
    FindStudentsByID: async (id) => {
        try {
            const response = await fetch("https://agomoni-2k25-2.onrender.com/api/students/studentData", {
                method: "POST",
                headers: {
                    "content-type": "application/json"
                },
